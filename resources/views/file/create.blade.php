...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<div class="form-group">
			...
			<div class="col-sm-5">
				<input id="nama" class="form-control" name="nama" type="text" placeholder="Nama file" value="{{ $nama or '' }}">
			</div>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input name="random_name" type="hidden" value="{{ $random_name or 'y' }}">
			<div class="col-sm-11">
...
<script>
	...
	$('form#upload').ajaxForm({
		...
		success: function(data) {
			...
			{
				window.location = "{{ $redirect or '/file' }}";				
			}
		},
