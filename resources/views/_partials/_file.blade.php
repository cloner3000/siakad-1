...
<script>
	...
	$('form#upload').ajaxForm({
		...
		complete: function(xhr) {
			...
			$('#filename').text({{ $label or 'Pilih file...' }});
		},
...
<div class="form-group">
	...
	<label for="file" class="btn btn-default" id="upload-label"><i class="fa fa-search" id="upload-icon"></i> <span id="filename">{{ $label or 'Pilih file...' }}</span></label>
</div>