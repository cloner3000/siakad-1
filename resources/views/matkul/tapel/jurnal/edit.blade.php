...
<div class="box box-warning">
	<div class="box-header with-border">
		<h3 class="box-title">Edit Jurnal Perkuliahan</h3>
		<div class="box-tools">
			<a href="{{ url('/kelaskuliah/' . $matkul_tapel_id . '/jurnal') }}" class='btn btn-warning btn-xs btn-flat' title='Jurnal'><i class='fa fa-book'></i></a>
		</div>
	</div>
	<div class="box-body">
		{!! Form::model($jurnal, ['method' => 'PATCH', 'class' => 'form-horizontal', 'role' => 'form', 'route' => ['matkul.tapel.jurnal.update', $matkul_tapel_id, $jurnal -> id], 'files' => true]) !!}
