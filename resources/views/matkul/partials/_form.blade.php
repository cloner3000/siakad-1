...
<div class="form-group">
	...
	<div class="col-sm-1">
			<input class="form-control" disabled id="total_sks" type="text" id="sks" name="sks_total" value={{ $matkul -> sks_total or 0 }} style="padding: 8px;" />
	</div>
...
<!--div class="form-group">
	{!! Form::label('tgl_mulai_efektif', 'Tgl. Mulai Efektif:', array('class' => 'col-sm-2 control-label')) !!}
	<div class="col-sm-3">
		{!! Form::text('tgl_mulai_efektif', null, array('class' => 'form-control', 'data-role' => "datebox", 'data-options' => '{"mode":"flipbox", "useTodayButton":"true", "popupPosition": "window"}' )) !!}
	</div>
</div>
<div class="form-group">
	{!! Form::label('tgl_akhir_efektif', 'Tgl. Akhir Efektif:', array('class' => 'col-sm-2 control-label')) !!}
	<div class="col-sm-3">
		{!! Form::text('tgl_akhir_efektif', null, array('class' => 'form-control', 'data-role' => "datebox", 'data-options' => '{"mode":"flipbox", "useTodayButton":"true", "popupPosition": "window"}' )) !!}
	</div>
</div-->
<div class="form-group">
