				...
				<td width="50%" valign="top">
					<table class="tabel-nilai">
						...
						<tbody>
							...
							<tr>
								<td colspan="6" style="padding: 10px 5px 20px 5px;">{{ $mahasiswa -> skripsi -> judul or '' }}</td>
							</tr>
						</tbody>
					</table>
				</td>
				...
				<td valign="top">
					<table class="tabel-nilai">
						...
						<tbody>
							...
							<tr><td colspan="2" style="text-align: left; padding: 5px; border-bottom-color: transparent; border-right-color: transparent;">IP :  {{ $ipk = $jsks  < 1 ? 0: round($jsksn  / $jsks , 2) }}</td><td colspan="4" style="text-align: left; padding: 5px 0px; border-bottom-color: transparent;">Yudisium : {{  predikat($ipk) }}</td></tr>
