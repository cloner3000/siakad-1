...
<section class="content-header">
	...
	<ol class="breadcrumb">
		...
		<li><a href="{{ route('mahasiswa.ppl.peserta', $ppl -> id) }}"> Peserta PPL</a></li>
...
<section class="content-header">
	...
	<ol class="breadcrumb">
		<li><a href="/"><i class="fa fa-dashboard"></i> Home</a></li>
		<!--li><a href="{{ url('/ppl/info') }}"> Informasi PPL</a></li-->
...
<div class="box box-primary">
	...
	<div class="box-body">
		...
		<div class="callout callout-danger">
			<h4>Kesalahan</h4>
			Pendaftaran PPL sudah ditutup. Silahkan menghubungi Bagian Akademik.
		</div>
		@else
		<div class="row">
			<div class="col-sm-3">
			...
			<div class="col-sm-9">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						@if($show)
						<p class="form-control-static"><strong>{{ $data -> ppl -> nama }} ({{ formatTanggal(date('Y-m-d', strtotime($data -> ppl -> tanggal_mulai))) }} - {{ formatTanggal(date('Y-m-d', strtotime($data -> ppl -> tanggal_selesai))) }})</strong></p>
						@else
						{!! Form::select('ppl_id', $ppl, null, ['class' => 'form-control']) !!}
						@endif
					</div>
				</div>
				<div class="form-group">
				...
				@if($show)
				@if($admin)
				<a href="{{ route('mahasiswa.ppl.peserta.cetak', [$data -> ppl -> id, $data -> id]) }}" class="btn btn-info btn-flat" ><i class="fa fa-print"></i> Cetak</a>
				@else	
				<a href="{{ route('mahasiswa.ppl.peserta.cetak2') }}" class="btn btn-info btn-flat" ><i class="fa fa-print"></i> Cetak</a>
				@endif
				@else		
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
