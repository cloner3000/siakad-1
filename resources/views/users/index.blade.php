...
@section('content')
<?php $filter = Input::get('filter', 'all'); ?>
...
<div class="box">
	...
	<div class="box-body">
		...
		@if(!$users->count())
		@if(isset($message))<p class="text-muted">{{ $message }}</p>@else<p class="text-muted">Tidak ditemukan hasil</p>@endif
		@else
				...
				<table class="table table-bordered">
					<thead>
						<tr>
							...
							<th>Pendidikan</th>
							@endif
							@if($filter == 'mahasiswa' or $filter == 'all')
							<th>NIM</th>
							<th>Prodi</th>
							<th>Kelas</th>
							@endif
