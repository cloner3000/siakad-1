<?php
	...
	class KurikulumMatkulController extends Controller
	{
		...
		{
			\DB::insert('INSERT IGNORE INTO `kurikulum_matkul` (`kurikulum_id`, `matkul_id`, `semester`, `wajib`) SELECT ' . $id . ', `matkul_id`, `semester`, `wajib` FROM `kurikulum_matkul` WHERE `kurikulum_id` = ' . Input::get('from'));
		...
		public function update($kurikulum_id)
		{
		...
		public function store($kurikulum_id)
		{
			$input = Input::except('_token');
